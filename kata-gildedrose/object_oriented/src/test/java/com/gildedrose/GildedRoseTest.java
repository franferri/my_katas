...
public class GildedRoseTest {
	...
	public void FruitQualityLossTwiceAsFast() {
		...
		Item[] items = new Item[] { new Item("fruit", 0, 4) };
	...
	public void FruitQualityWillNeverBeNegative() {
		...
		Item[] items = new Item[] { new Item("fruit", 0, 0) };
	...
	public void BackstageBeforeTenDays() {
		...
		Item[] items = new Item[] { new Item("Backstage passes to a TAFKAL80ETC concert", 12, 5), new Item("Backstage passes to a TAFKAL80ETC concert", 12, 50) };
	...
	public void BackstageBetweenTenDaysAndSixDays() {
		...
		Item[] items = new Item[] { new Item("Backstage passes to a TAFKAL80ETC concert", 10, 5), new Item("Backstage passes to a TAFKAL80ETC concert", 6, 5) };
	...
	public void BackstageBetweenFiveDaysAndZeroDays() {
		...
		Item[] items = new Item[] { new Item("Backstage passes to a TAFKAL80ETC concert", 5, 5), new Item("Backstage passes to a TAFKAL80ETC concert", 1, 5) };
